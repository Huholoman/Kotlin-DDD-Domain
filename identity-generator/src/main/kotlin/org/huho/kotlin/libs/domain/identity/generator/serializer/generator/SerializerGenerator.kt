...
class SerializerGenerator(
    ...
    fun generate(serializerInfo: SerializerInfo) {
        ...
        val serializerClass = TypeSpec.Companion.classBuilder(serializerInfo.classInfo.className)
            .addSuperinterface(KSerializer::class.asClassName().parameterizedBy(targetClassName))
            .addFunction(
                FunSpec.Companion.builder("serialize")
            ...
            .addFunction(
                FunSpec.Companion.builder("deserialize")
                    .addModifiers(KModifier.OVERRIDE)
        ...
        FileSpec.builder(serializerInfo.classInfo.packagePath, serializerInfo.classInfo.className)
